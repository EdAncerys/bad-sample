...
const BADTheme = {
  ...
  state: {
    ...
    auth: {
      ...
      B2C: "https://britishaderm.b2clogin.com/BritishADerm.onmicrosoft.com/oauth2/v2.0/authorize?p=B2C_1_signupsignin_prod&client_id=c0f5bfaa-713d-4e85-9579-55c1f2257b28&nonce=defaultNonce", // B2C auth logon service
