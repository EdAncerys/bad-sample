...
// --------------------------------------------------------------------------------
const userBlobFields = `gendercode,py3_ethnicity,birthdate,bad_preferredmailingaddress,bad_includeinfindadermatologist,bad_bademailalerts,bad_badecircular,bad_presidentsbulletin,bad_bjdalerts,donotemail,bad_newhospitaladded,bad_mrpcqualified,bad_memberdirectory,py3_constitutionagreement,bad_readpolicydocument,bad_hasmedicallicence,bad_includeinthebssciiemaildiscussionforum,formus_professionalregistrationbody,formus_professionalregistrationstatus,formus_residencystatus,formus_qualificationtype,formus_otherqualificationtype,formus_othermainspecialtyqualification,formus_otherreasonformovingccstdate,formus_mainspecialtyqualification,formus_clinicalspecialtysofpractice,formus_specialiseddermatologyareasofpractice,formus_typeofcontract,formus_fixedtermtemporaryreasonforemploymentcont,formus_rotapattern,formus_typeofpractice,formus_privatepracticeorganisation,formus_reasonformovingccstdate,formus_staffgroupcategory,formus_jobrole`;
